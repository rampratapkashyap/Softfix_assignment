  ...
  const blogsData = [
    {
      title:"Softfix",
      type: "lucknow",
      description: "Hire React JS dev with JS, React, web dev skills. Consider problem solving and team experience. Find via job boards, freelancing, networks. Vetting and interviews necessary.",
    },
    {
      title:"Softfix",
      type: "lucknow",
